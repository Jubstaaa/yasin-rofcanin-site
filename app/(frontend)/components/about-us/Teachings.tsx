    ...
    <div className="flex flex-col gap-10 items-center">
      ...
      <div className="grid grid-cols-4 container mx-auto">
        {teachings.map((teaching) => (
          <div
            key={teaching.id}
            className="group flex flex-col gap-4 items-start p-8 border border-transparent hover:border-primary relative overflow-hidden"
          >
            ...
            <Icon icon={teaching.icon} className="w-12 h-12 relative" />
            <h3 className="text-xl font-medium relative">{teaching.name}</h3>
