    ...
    <footer className="w-full flex items-center justify-center border-t border-gray-100 shadow-sm bg-white p-12 pt-12 mt-12">
      <div className="grid grid-cols-4 container mx-auto gap-10">
        <div className="flex flex-col gap-6">
          ...
          />
          <p>
            Professor of Organisational Behaviour, passionate about how flexible
            work practices, proactive employee behaviours, and work-family
            enrichment shape well-being and effectiveness at work; published in
            leading journals, and actively contributes to the field as an
